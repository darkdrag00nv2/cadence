...
func ExportMeteredType(
	...
	result := func() cadence.Type {
		...
		case *sema.RangeType:
			return exportRangeType(gauge, t, results)
...
func exportRangeType(
	...
	return cadence.NewMeteredRangeType(
		gauge,
		convertedMemberType,
	)
}
...
func ImportType(memoryGauge common.MemoryGauge, t cadence.Type) interpreter.StaticType {
	...
	case *cadence.RangeType:
		return interpreter.NewRangeStaticType(memoryGauge, ImportType(memoryGauge, t.ElementType))
